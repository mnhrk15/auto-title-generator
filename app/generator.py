...
"""
            ...
            season_instruction = f"""
- **シーズン対応:**
    - 特定のシーズン指定はありませんが、もし可能であれば、現在の日本の一般的な季節感や美容トレンドに合ったシーズンワードを適宜取り入れてください。必須ではありません。
"""
...
タイトルには必ずキーワード「{keyword}」を含め、合計で5つ以上のキーワードを盛り込んでください。これにより検索露出を最大化し、より多くのユーザーにアピールできます。
